...
#Madison's Bounding Box
#streamer.filter(locations=[-89.566389,42.998071,-89.246452,43.171916])
#United States of America Bounding Box
USA_BBOX = [-175.1, 22.4, -59.8, 72.3]
streamer.filter(locations=USA_BBOX)